...
ENV BOTPRESS_MESSAGE_ENDPOINT=$BOTPRESS_MESSAGE_ENDPOINT
ENV BOTPRESS_BOT_ID=$BOTPRESS_BOT_ID
ENV BOTPRESS_PAT=$BOTPRESS_PAT
...
RUN echo "OPENAI_API_KEY=$OPENAI_API_KEY" && \
    ...
    echo "BOTPRESS_MESSAGE_ENDPOINT=$BOTPRESS_MESSAGE_ENDPOINT" && \
    echo "BOTPRESS_BOT_ID=$BOTPRESS_BOT_ID" && \
    echo "BOTPRESS_PAT=$BOTPRESS_PAT" && \
